...
![Example banner](../images/balance/login.png)

![Example banner](../images/balance/dashboard.png)
...
![Example banner](../images/balance/basics-manufacturer.png)
...
![Example banner](../images/balance/manufacturer-new.png)
![Example banner](../images/balance/abbreviation-name-manufacturer.png)
![Example banner](../images/balance/basics-manufacturer-edit.png)


4. Now, create the Equipment Template, for this, select the option of the same name from the main menu and load its home:

![Example banner](../images/balance/equipment-template-new.png)


5. Select the Scale option in Equipment Type
![Example banner](../images/balance/equipment-template-edit-scale.png)
...
![Example banner](../images/balance/scale-manufacturer-status-unitofmeasure.png)
...
![Example banner](../images/balance/equipment-tolerancetype-resolution.png)
...
![Example banner](../images/balance/equipmenttemplate-tolerancetype-resolution-resolutionnumbre-0.1.png)


9. Expand the Other Information section. This field is optional, but additional observations can be added if necessary.

![Example banner](../images/balance/equipmenttemplate-otherinformation-description.png)


10. Select the Procedure option from the main menu, load its home page, and click on the New button.

![Example banner](../images/balance/basics-procedure-new.png)


11. You must enter the name of the procedure, attach a file in PDF format, and save.

![Example banner](../images/balance/basics-procedure-precedurename-save.png)

![Example banner](../images/balance/basics-procedure-list-.png)

12. Select the Test Codes option from the main menu, load its home, and click on the New button.

![Example banner](../images/balance/basics-testcodes-new.png)
...
![Example banner](../images/balance/basics-tescodes-new-calitationtypesclae-rangemax-unitofmeasurement-procedure.png)

14. Expand the Customer option from the main menu, click on Customer, load its home page, and click on the New button:

![Example banner](../images/balance/basics-customer-new.png)
